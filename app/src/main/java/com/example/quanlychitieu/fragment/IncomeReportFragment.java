...
public class IncomeReportFragment extends Fragment {
    ...
    public void updateData(int month, int year) {
        ...
        // Lấy dữ liệu thu nhập từ DAO
        reportDataList = reportDAO.getReportData(userId, month + 1, year, "INCOME");
        ...
        if (reportDataList.isEmpty()) {
            pieChart.clear();
            pieChart.setNoDataText("Không có dữ liệu thu nhập tháng " + (month + 1));
